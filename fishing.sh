...
echo
echo $cy "??????????????????????????????????????????????????????????"
echo $i  "AUTHOR   : ꧁💓 @:꓄ꍏꈤᖘꍏ꓄꓄ꍏꌩ💓꧂-Selfbot"
echo $i  "LINE       : https://line.me/R/ti/p/~ptatan1983"
echo $i  "YOUTUBE  : tanflex-Selfbot"
...
sleep 2
echo $i"Line :"$i" @ptatan1983"
echo $bi"Team :"$i" ꧁💓 @:꓄ꍏꈤᖘꍏ꓄꓄ꍏꌩ💓꧂SelfBots_Line"
exit
fi
